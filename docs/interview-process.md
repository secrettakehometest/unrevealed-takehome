...
> 
> Let me know if anything changes or if you have any questions!
> 
> Thanks,
> Recruiter
...
> 
> I'm available next week on (ECT):
> 
> November 12 > 12pm ~ 4pm
> 
...
> 
> I'll be direct: this interview process has been unexpectedly clarifying for me as well. After thirty years in this industry: building and shipping production systems, contributing to widely‑used open source frameworks, and maintaining a public professional presence. I've come to expect interview formats that respect the experience of senior engineers.
> 
> The live‑coding portion of this process did not meet that bar. In the freelance and consulting world, that type of work is functionally discovery, and discovery is never unpaid. Between the technical exercise, the take‑home, and the earlier calls, I spent several hours that, in any other context, would be treated as billable. Instead, I found myself performing edits under observation, as though that were a meaningful representation of my capabilities. It wasn't productive for me, and I doubt it offered you much real insight either.
> 
> This experience has made a few things clear. Going forward, I'll be declining any interviews that rely on live pairing, leet‑style exercises, or take‑home coding tests for senior roles. My open‑source work, published projects, and leadership history offer a far better picture of what I bring to a team than watching me adjust hard‑coded values in a contrived environment.
> 
> I appreciate the time your team invested, and I hope you find the candidate who fits what you're looking for. This process has at least helped me refine what I'm willing to entertain in the future.
> 
> Best regards,
> Candidate
...
**Time Spent:** ~42 minutes (initial implementation)

**Requirements:**
- Build a small full-stack application (Task Manager)
- CRUD operations (create, view, update, delete, search)
...
**Duration:** 30 minutes (extended to ~45 minutes)  
**Format:** Google Meet video call with screen share  
**Time:** 4pm EST (rescheduled from 3pm EST)

#### Summary

**Action Items Identified:**
- Send interviewers the GitHub walkthrough link
- Update docker-compose.yml to declare the db_data volume explicitly
- Consolidate task status values into a shared constant/module (e.g., TaskStatuses::STATUSES)
- Add/adjust unit tests for status validation
- Prepare a short diagram showing the Docker container, SQLite DB, and front-end stack
...
1. **Docker Volumes Issue:**
   - docker-compose.yml references db_data volume only inside the web service, not declared globally
   - Still works because Docker auto-creates an unnamed volume at runtime
   - Best practice: declare named volumes explicitly for portability and clarity

2. **Code Organization Concern:**
   - Task status values duplicated across backend and frontend files (5 locations: migration, model validation, default, forms, and view logic)
...
- **Why does the volume work without explicit declaration?**  
  Docker auto-creates the volume at runtime when a path is mounted but not pre-declared.

- **How to improve status handling?**  
  Move all status definitions to a single constant/module and reference it everywhere (model, controller, front-end).
...
**Communication:**
- Kept the conversation direct and transparent; didn't oversell or soft-pedal the limitations of the demo code
- Admitted to using Cursor for speed—justified as a best practice for fast, error-free scaffolding, with manual audit/refactor afterward
- Walked through Docker concepts, why containerize/not, and trade-offs in ephemeral setups
- Was honest about "how I'd do it in prod vs. demo"

**Vibe/Soft Skills:**
- Engineers were civil but not especially animated or curious; mostly just checked boxes and asked for explanations
- Energy was low and clock-watching toward the end
- The entire exercise felt like technical theater, not a real collaboration or engineering problem
- Personally: Found it draining and uninspiring—if the salary wasn't almost $200K, impulse would have probably bailed

**Reflection:**
- Can pass these—delivered everything they wanted, live-fixed what they didn't like, ran tests, and closed the loop
- The value of code tests for senior hires is pretty dubious, especially when you have public code, references, and architecture work to show

#### Full Transcript

*[See detailed transcript below - 45+ minutes of conversation covering setup, code walkthrough, Docker volumes discussion, live refactoring of status enum, and Q&A]*
...
**Them [2:09]:** so cold a lot of the year
...
**Them [2:56]:** this whole thing is about the size of massachusetts i think the whole metroplex
...
**Them [3:34]:** i'm an elder

**Them [3:41]:** full stack dev i've been around doing tech since the nineties

**Them [3:49]:** i've been spending the last couple of years focusing on agentic ai stuff with a lot of

**Them [4:11]:** well i would say two big startups one is quasar which was kind of an interesting game with some business ip that was generated off of it and then there was sanctum os which is the nonprofit that i started that kind of owns most of the ip i generate elsewhere and just kind of like an open source foundation

**Them [4:19]:** that has built a bunch of really interesting stateful agent installations for people

**Them [4:22]:** i don't know

**Them [4:26]:** sixty seconds or less on the clock what i've been up to for the last couple years
...
**Them [7:00]:** what are people on for you mostly like mac stuff or what
...
**Them [7:26]:** was told they had to do stuff on azure

**Them [7:31]:** and we do not have much windows expertise in house right now
...
**Them [8:15]:** so yeah let's just kind of start walking us through
...
**Them [10:34]:** there's like a little oh yeah yeah all right they move the buttons around

**Them [10:36]:** every every time i try to lag stuff

**Them [10:42]:** so there's like the that's the walkthrough and it's got like screenshots of everything
...
**Them [13:40]:** you switch over to the code so we can kind of look at that and just kind of walk through sure
...
**Them [15:38]:** to makeup farsight those things
...
**Them [22:23]:** db data and the volumes
...
**Them [23:02]:** you have db data

**Them [23:10]:** set to the binding that directory is the
...
**Them [24:21]:** exists defined several different locations across the backend and front end uniquely within different files

**Them [24:26]:** several different ways you could improve that

**Them [24:31]:** but maybe you could throw out some ideas about how you might improve
...
**Them [24:51]:** like the first location those are defined and walk us through that
...
**Them [25:12]:** in several different locations

**Them [25:14]:** all of them

**Them [25:16]:** but i just wanted you to

**Them [25:21]:** walk me through how you might improve the app

**Them [25:26]:** to you know not have to like if you had to add more statuses
...
**Them [26:50]:** how would you pass that
...
**Them [34:54]:** i'm just calling

**Them [34:57]:** the i'm calling the enum options here
...
**Them [45:48]:** probably sometime tomorrow

**Them [45:52]:** so it's good to good to talk to you again okay

**Them [45:52]:** sounds good

**Them [45:55]:** thank you
...
*This document will be updated with detailed meeting notes as they are provided.*
